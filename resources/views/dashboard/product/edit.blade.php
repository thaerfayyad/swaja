            ...
            <form class="form d-flex flex-column flex-lg-row" id="create-form">
                ...
                <div class="d-flex flex-column flex-row-fluid gap-7 gap-lg-10">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-12 col-sm-12 mt-6">
                                                ...
                                                <div class="image-input image-input-empty" data-kt-image-input="true"
                                                    style="background-image:   @if(! $product->image)  url({{asset('assets/media/avatars/blank.png')}})   @else  url('{{url(Storage::url( $product->image))}}') @endif">
                    ...
                    <div class="d-flex justify-content-end">
                        ...
                        <button type="button" onclick="update('{{$product->id}}')" class="btn btn-primary">
...
@section('js')
    ...
    <script>
        function update(id) {
            ...
            axios.post('/dashboard/products/'+id, formData).then(function (response) {
