            ...
            <form class="form d-flex flex-column flex-lg-row" id="create-form">
                ...
                <div class="d-flex flex-column flex-row-fluid gap-7 gap-lg-10">
                                    ...
                                    <div class="container">
                                        <div class="row">
                                            <div class="col-md-4 col-sm-12 mt-8">
                                                ...
                                                <input type="text" class="form-control form-control-solid" value="{{ $category->name }}" id="title"
                                                    name="name">
                    ...
                    <div class="d-flex justify-content-end">
                        ...
                        <button type="button" onclick="update('{{$category->id}}')" class="btn btn-primary">
...
@section('js')
    ...
    <script>
        function update(id) {
            ...
            axios.post('/dashboard/categories/'+id, formData).then(function (response) {
